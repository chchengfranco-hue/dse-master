  ...
  return (
    <div className="px-4 lg:px-8 py-6 max-w-3xl mx-auto">
      <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
          <div>
            <label className="text-xs font-semibold text-foreground mb-1 block">Exam Title <span className="text-destructive">*</span></label>
            <input className="w-full rounded-xl border border-input px-3 py-2 text-sm" placeholder="e.g. 2021 Paper 4 — Technology" value={form.title} onChange={e => s('title', e.target.value)} />
          </div>
          <div>
            ...
            <input className="w-full rounded-xl border border-input px-3 py-2 text-sm" placeholder="e.g. 2023 DSE Paper 4 Q2" value={form.examRef} onChange={e => s('examRef', e.target.value)} />
          </div>
        </div>
